 ...
 * @author ennio
 */
public class BoostingDataset implements eu.cloudtm.Dataset.Dataset{
     static Logger logger = Logger.getLogger(BoostingDataset.class.getName());
     
     public static Instances BoostingDataset;
     private BoostingConfiguration BC=BoostingConfiguration.getInstance();
     
    public BoostingDataset(String Directory_path) throws Exception{
         ...
         try{
             ...
             BoostingDataset=ExtendInstances();
      ...
      for (File nextdir : dir.listFiles()) {
         ...
         DataPrinting.PrintDataSet(BoostingDataset);
         }      
        catch(Exception e){
